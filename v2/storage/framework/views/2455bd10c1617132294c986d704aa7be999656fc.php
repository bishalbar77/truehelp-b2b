        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info" style="border-radius: 12px;">
              <div class="inner">
                <h3><?php echo e($registered_employees); ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success" style="border-radius: 12px;">
              <div class="inner">
                <h3><?php echo e($pending_verifications); ?><sup style="font-size: 20px"></sup></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning" style="border-radius: 12px;">
              <div class="inner">
                <h3><?php echo e($verified_employees); ?></h3>
              ...
              <div class="card-body" >
                    <table class="table" id="datatable">
                        ...
                        <?php if(isset($employees)): ?>
                          ...
                          <?php if($sl>4): ?><?php continue; ?>;<?php endif; ?>
                            <tr>
                                ...
                                <a href="<?php echo e(route('verify', 1 )); ?>" type="submit" class="Verify- float-right">								
                                Verify ></a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/home.blade.php ENDPATH**/ ?>