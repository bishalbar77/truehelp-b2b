              ...
              <div class="card-body" >
                    <table class="table" id="datatable">
                        ...
                        <tbody class="t-body">
                          ...
                          <?php if($employee->user_type=='Employee'): ?>
                            <tr>
                                ...
                                <td>
                                <?php if( $employee->is_active==1): ?>
                                <a href="<?php echo e(route('employees.changestatus', $employee->id )); ?>" class="pl-3" type="submit"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <?php else: ?>
                                <a href="<?php echo e(route('employees.changestatus', $employee->id )); ?>" type="submit" class="Verify-">								
                                Verify ></a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Truehelp\resources\views/employees/index.blade.php ENDPATH**/ ?>