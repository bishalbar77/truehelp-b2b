      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form method="POST" class="form-signin" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="mobile" required>
...
<?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/auth/register.blade.php ENDPATH**/ ?>