            ...
            <div class="p-xl-5 pt-xl-5">
              <div class="form-group row">
                ...
                <div class="col-lg-9 pt-1 pl-5">
                  <p class="Name"><?php echo e($account->b2b_company_name); ?></p>
                  <p class="bottom-text"><?php echo e($account->email); ?></p>
                  <p class="bottom-text">Ph no: <?php echo e($account->mobile); ?></p>             
          ...
          <div class="col-lg-6">
            <div class="p-xl-5 pt-xl-5">
              <div class="form-group row">
                ...
                <div class="col-lg-9 pt-1 pl-5">
                  <p class="Name"><?php echo e($account->b2b_brand_name); ?></p>
                  <p class="bottom-text">GST No: <?php echo e($account->b2b_gst_no); ?></p>
                  <p class="bottom-text">PAN No: <?php echo e($account->b2b_pan_no); ?></p>             
                  <a href="<?php echo e($account->b2b_website); ?>" target="_blank"><p class="web pt-2"><i class="fa fa-internet-explorer fa-lg pr-2" aria-hidden="true"></i><?php echo e($account->b2b_website); ?></p></a>				
                </div>
              </div>
            </div>
          </div>
       ...
       <div class="col-lg-12">
        <div class="box-item">
          ...
          <div class="pl-5 pt-3">
            ...
            <label>Timezone<a class="pl-2"><input type="text" value="<?php echo e($preferences->time_zone); ?>" disabled></a></label><br>
            </p>
          </div>
        </div>
       </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/company/profile.blade.php ENDPATH**/ ?>