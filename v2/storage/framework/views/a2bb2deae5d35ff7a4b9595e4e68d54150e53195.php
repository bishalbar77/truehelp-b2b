...
<?php $__env->startSection('content'); ?>
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="pl-2 pt-2">
        <p class="nav-name"><?php echo e(session()->get('first_name')); ?></p>
      </li>
      <li class="pl-2 pt-2">
          ...
          <div class="p-xl-5 pt-xl-5">
            <div class="form-group row">
              ...
              <div class="col-lg-9 pt-1 pl-5">
                <p class="Name"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></p>
                <p class="bottom-text"><?php echo e($user->type); ?></p>
                <p class="bottom-text">Ph no: <?php echo e($user->mobile); ?></p>  
        ...
        <div class="col-lg-6">
          <div class="box-item">
            <div class="form-group row pt-5 pl-5">
              ...
              <p class="body-text-sm-4"><?php echo e($user->type); ?></p>
              </div>
              <div class="col-lg-6">
              <p class="body-text-4">Age</p>
              <p class="body-text-sm-4"><?php echo e(\Carbon\Carbon::parse($user->dob)->diff(\Carbon\Carbon::now())->format('%y years')); ?></p>
              </div>
            </div>
            <div class="form-group row  pl-5">
              <div class="col-lg-6">
              <p class="body-text-4">Join Date</p>
              <p class="body-text-sm-4"><?php echo e(\Carbon\Carbon::parse($user->employment_start)->diff(\Carbon\Carbon::now())->format('%y years & %m months')); ?></p>
              </div>
              <div class="col-lg-6">
              <p class="body-text-4">Salary</p>
              <p class="body-text-sm-4"><?php echo e($user->salary); ?></p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="box-item">
            ...
            <div class="form-group row pl-5 pb-3">
              ...
              <?php if(isset($user_docs)): ?>
              <?php $__currentLoopData = $user_docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_docs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e($user_docs->doc_url); ?>" target="_blank"><img src="images/aadhar.png" alt="User Avatar"  class="aadhar"></a>
      ...
      <div class="row">
       <div class="col-lg-12">
        <div class="box-item">
          ...
          <hr>
          <?php $__currentLoopData = $employee_lookup_histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="pl-5 pt-3">
            ...
            <tr>
            <td>Position</td>
            <td><?php echo e($history->employee_type); ?></td>
            </tr>
            <tr>
            <td>Document Verified</td>
            <td><?php echo e($history->document_type); ?></td>
            </tr>
            </table>
            <br><br>
          </div>
      ...
      <div class="row">
       <div class="col-lg-12">
        <div class="box-item">
          ...
          <hr>
          <!-- <?php if(isset($verification_types)): ?>
          <?php $__currentLoopData = $verification_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="pl-5">
            <p class="body-text-4"><?php echo e($vtype->name); ?></p>
            <p class="amount">Rs. <?php echo e($vtype->amount); ?></p>
            <p class="Lorem-ipsum-dolor-si">
            <?php echo e($vtype->description); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/employees/verify.blade.php ENDPATH**/ ?>