            ...
            <div class="Rectangle-Copy-6 pl-4 t-head">
              ...
              <div class="card-body" >
                    <table class="table" id="datatable">
                      <?php if(isset($survey_answers)): ?>
                      <?php $__currentLoopData = $survey_answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $survey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <thead class="pt-2">
                            <tr>
                                <th>Q. <?php echo e($survey->question_name); ?></th>
                            </tr>
                        </thead>
                        <tbody class="t-body">
                        <tr>
                          <td>A. <?php echo e($survey->question_answer); ?></td>
                        </tr>
                        </tbody>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/health/showhealthcheck.blade.php ENDPATH**/ ?>