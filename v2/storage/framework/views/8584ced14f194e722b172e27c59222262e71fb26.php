  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data" action="/import">
        ...
        <div class="form-group row pr-5 pl-5">
            <a class="Download-Template pl-2" href="<?php echo e(route('students.export')); ?>"><i class="nav-icon fa fa-user pr-2"></i>Download Template</a>
        </div>
              ...
              <div class="card-body" >
                    <table class="table" id="datatable">
                        ...
                        <tbody class="t-body">
                          ...
                          <?php if($employee->user_type=='Student'): ?>
                            <tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Truehelp\resources\views/student/index.blade.php ENDPATH**/ ?>