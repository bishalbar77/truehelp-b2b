                        ...
                        <tbody class="t-body">
                          <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($employee->user_type); ?></td>
                                <td></td>
                                <td>
                                <?php if( $employee->is_active==1): ?>
                                <span class="VERIFIED">Verified</span>
                                <a href="<?php echo e(route('employees.changestatus', $employee->id )); ?>" class="pl-3 float-right pr-4 " type="submit"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <?php else: ?>
                                <span class="UNVERIFIED">Unverified</span>
                                <a href="<?php echo e(route('employees.changestatus', $employee->id )); ?>" type="submit" class="Verify- float-right">								
                                Verify ></a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/employees/search.blade.php ENDPATH**/ ?>