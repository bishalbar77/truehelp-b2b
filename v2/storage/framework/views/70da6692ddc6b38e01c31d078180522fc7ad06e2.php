                    ...
                    <table class="table" id="datatable">
                        ...
                        <?php if($orders!=""): ?>
                          <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($order->survey_type); ?></td>
                                <td><?php echo e($order->employee_id); ?></td>
                                <td><?php echo e($order->survey_start); ?></td>
                                <td><?php echo e($order->survey_end); ?></td>
                                <td>
                                <?php echo e($order->survey_status); ?><a href="<?php echo e(route('checksurvey', $order->id )); ?>" class="float-right" type="submit">Check ></a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/health/index.blade.php ENDPATH**/ ?>