            ...
            <div class="p-xl-5 pt-xl-5">
              <div class="form-group row">
                ...
                <div class="col-lg-9 pt-1 pl-5">
                  <p class="Name"><?php echo e(session()->get('first_name')); ?></p>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/employees/profile.blade.php ENDPATH**/ ?>