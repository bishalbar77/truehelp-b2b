...
<head>
    ...
    <title><?php echo e(config('app.name', 'TrueHelp - India first ML/AI based complete service for employees.')); ?></title>
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form method="POST" class="form-signin" action="<?php echo e(route('checkotp')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($mobile); ?>" name="mobile" required>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-label-group">
              <input id="OTP" type="number" class="form-control <?php $__errorArgs = ['OTP'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="OTP" required>
...
<?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/auth/veriifyOtp.blade.php ENDPATH**/ ?>