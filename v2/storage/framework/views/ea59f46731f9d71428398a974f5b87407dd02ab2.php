        ...
        <div class="form-group row">
            ...
            <input type="email" class="form-control" name="email">
              ...
              <select name="emp_type" class="form-control" id="emp_type">
                  ...
                  <?php $__currentLoopData = $emp_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value=<?php echo e($emp->id); ?>><?php echo e($emp->type); ?></option>
                ...
                <table class="table table-stripped">
                    ...
                    <?php $__currentLoopData = session()->get('failures'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $failure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                            <?php $__currentLoopData = $failure->errors(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <ul><?php echo e($e); ?></ul>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </td>
                            <td>
                                <?php echo e($failure->values()[$failure->attribute()]); ?>
                        ...
                        <?php if(isset($employees)): ?>
                          <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php if( $employee->type=="I"): ?>
                                <span class="VERIFIED">Verified</span>
                                <a href="<?php echo e(route('verify', 1 )); ?>" class="pl-3 float-right pr-4 " type="submit"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                <?php else: ?>
                                <span class="UNVERIFIED">Unverified</span>
                                <a href="<?php echo e(route('verify', $employee->employee_id )); ?>" type="submit" class="Verify- float-right">								
                                Verify ></a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pro Fo 2\truehelp-b2b\v2\resources\views/employees/index.blade.php ENDPATH**/ ?>