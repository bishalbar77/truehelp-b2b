...
<link rel="stylesheet" href="https://enterprise.gettruehelp.com/tokenize2.css">
<!--body-->
<?php
    ...
    <ul class="navbar-nav ml-auto" id="navbar">
      ...
      <li class="nav-item dropdown navbar-collapse collapse">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="card-box text-center p-2"><h3 class="noti-text">{{$count}} New</h3><p class="noti-text-light">App Notifications</p></div>
...
<script src="https://enterprise.gettruehelp.com/tokenize2.js"></script>
<script>
