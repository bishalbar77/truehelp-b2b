        ...
        <div class="form-group row">
          <div class="col-lg-6">
            <div class="p-xl-5 pt-xl-5">
              <div class="form-group row">
                <div class="col-lg-3">
                  <img src="{{ asset('dist/img/avatar04.png') }}" alt="User Avatar"  class="img-circle Mask">
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group row pr-1">
                      ...
                      Candidate have not completed Today's survey yet,
                      send the post survey request again.
                      </p>
                    </div>
                    <div class="form-group row pr-1">
